...
const Default = (mode) => {
  ...
  if (mode === ThemeMode.DARK) {
    primaryColors = ['#03D364', '#2F63FF', '#376DFF', '#3F78FF', '#4680FF', '#1DF180', '#7EA6FF', '#A3C0FF', '#C8D9FF', '#E9F0FF'];
    secondaryColors = ['#131920', '#1D2630', '#3E4853', '#212121', '#8996A4', '#BEC8D0', '#DBE0E5', '#F3F5F7', '#F8F9FA', '#F8F9FA'];
    errorColors = ['#c50d0d', '#d31c1c', '#dc2626', '#e76767', '#f5bebe'];
    warningColors = ['#d35a00', '#de7700', '#e58a00', '#edad4d', '#f7dcb3'];
    infoColors = ['#1ba9bc', '#30bccc', '#1DF180', '#1DF180', '#c5eff3'];
    successColors = ['#E3E3E3', '#21976c', '#F4F4F4', '#6bc2a5', '#c0e5d9'];
  }
